...
//    }
    ...
    for ( size_t i = 0; i < ( 34.5 - 33.6 ) * scale_x; i++ )
    {
        ...
        cmap.addPoint( (( 33.6 - object_x->minValue() ) * scale_x + i ) * grid_y + grid_y, kvs::RGBColor( 0, 255, 0 ) );
    }
    ...
    for ( size_t i = 0; i < ( object_x->maxValue() - 34.5 ) * scale_x; i++ )
    {
        ...
        cmap.addPoint( (( 34.5 - object_x->minValue() ) * scale_x + i ) * grid_y + grid_y, kvs::RGBColor( 255, 0, 0 ) );
    }
//
//    
//    // red
